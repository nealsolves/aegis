...
_PUBLIC_MESSAGES = MappingProxyType(
    {
        ...
        "WORKFLOW_PROTOCOL_TRACE_ALIAS_MISMATCH": "The provider trace did not match the governed binding.",
        "WORKFLOW_UNSUPPORTED_BINDING": "The provider binding is not supported by this demo.",
        "WORKFLOW_PROTOCOL_GRPC_UNSUPPORTED": "The provider protocol is not supported by this demo.",
        "POLICY_DATE_INVALID": "The policy is not active for the selected date.",
