# AEGIS `v0.9.0` PR-01 through PR-08 Implementation Review Prompt

Use this prompt in Claude Code or Codex.

---

You are reviewing the **local `develop` branch** of the AEGIS repository.
...
- AEGIS must remain an **SDK**, not become a hosted runtime, orchestrator, or transport owner.
...
- Workflow adoption is intended to be **instance-scoped through `AEGIS.open_session(...)`**.
