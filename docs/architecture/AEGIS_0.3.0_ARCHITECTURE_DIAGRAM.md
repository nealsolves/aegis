# AEGIS v0.3.0 Architecture Diagram
...
`docs/architecture/ENFORCEMENT_PIPELINE.md` and `docs/AEGIS_FRAMEWORK.md`.
...
- `@governed` is post-call governance. The wrapped function runs first, then
  AEGIS assembles the invocation and enforces policy on the result.
