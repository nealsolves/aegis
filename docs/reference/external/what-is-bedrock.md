...
|  ![\[Wrench and screwdriver icon on purple background.\]](http://docs.aws.amazon.com/bedrock/latest/userguide/images/what-is/build.jpg)  | Build using the [Submit prompts and generate responses with model inference](inference.md) operations provided by Amazon Bedrock. | 
