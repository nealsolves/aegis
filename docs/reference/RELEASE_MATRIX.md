...
- The truth-audit adapter, Python coverage, React, build, API, and browser
  matrix is complete. The canonical full-suite total remains deferred only
  until the separately authorized instruction-guide status correction turns
  its deliberate parity guard green.
