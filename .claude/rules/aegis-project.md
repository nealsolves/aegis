...
This module preserves the repository-specific engineering, architecture,
testing, and Git guidance that predated the spec-driven delivery kernel. It is
always routed by `.claude/routing.yaml`.
