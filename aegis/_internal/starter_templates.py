"""
Starter template content for aegis workflow init.

Each render_*_starter() function returns {filename: content} for a profile.
All generated content uses public aegis imports only.
"""
...
"""
Minimal AEGIS workflow example.

Generated by: aegis workflow init --profile minimal

Run:
    python workflow_example.py

Demonstrates a 2-step governed workflow using public AEGIS APIs.
...
3. See the AEGIS migration guide at
   https://github.com/nealsolves/aegis/blob/develop/docs/migration.md
...
"""
Standard AEGIS workflow example -- approval checkpoint.

Generated by: aegis workflow init --profile standard
...
"""
Regulated High Assurance AEGIS workflow example.

Generated by: aegis workflow init --profile regulated-high-assurance
