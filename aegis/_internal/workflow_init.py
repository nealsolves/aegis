"""Implementation of the `aegis workflow init` CLI command."""
...
from aegis._internal.errors import WorkflowStarterIntegrityError
...
def _cmd_workflow_init(args: argparse.Namespace) -> int:
    """Run the `aegis workflow init` subcommand."""
